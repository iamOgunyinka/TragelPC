...
void AddProductDialog::OnAddItemButtonClicked()
{
    ...
    utilities::Product const value{ product_name, temp_file, "", price, 0 };
...
void AddProductDialog::UpdateModel( utilities::Product const & data_item,
                                    int const index )
{
...
void AddProductDialog::OnEditItemButtonClicked()
{
    ...
    utilities::Product& item = product_item_list[current_row];
